        ...
        <div class="tab-content">
            ...
            <form id="form" action="<?=U('article/update')?>" method="post" class="form-horizontal">
                                        ...
                                        <case value="string">
                                            ...
                                            <?php case 'picture':?>
                                                <div class="controls">
                                                    ...
                                                    <input type="hidden" name="<?=$field['name']?>" id="cover_id_<?=$field['name']?>" value="<?=isset($data[$field['name']])?$data[$field['name']]:0?>"/>
                ...
                <div class="form-item cf">
                    ...
                    <?php if(\common\help\CommonHelper::C('OPEN_DRAFTBOX') &&HTMLHelper::getAction()){?>
                    ...
                    <?php }else{?>
                        <input type="hidden" name="id" value="<?=isset($data['id'])?$data['id']:0?>"/>
                        <input type="hidden" name="pid" value="<?=isset($dataAdd['pid'])?$dataAdd['pid']:0?>"/>
                        <input type="hidden" name="model_id" value="<?=isset($dataAdd['model_id'])?$dataAdd['model_id']:0?>"/>
                        <input type="hidden" name="category_id" value="<?=isset($dataAdd['category_id'])?$dataAdd['category_id']:0?>">
                    <?php }?>
                </div>
            </form>
        </div>
...
<?php if(C('COLOR_STYLE')=='blue_color'){ ?> <link href="/public/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" type="text/css">';<?php }?>
    ...
    <script type="text/javascript">
        setValue("type",<?=isset($data['type'])?$data['type']:1?>);
        setValue("display",<?=isset($data['display'])?$data['display']:1?>);
        ...
        $(function(){
            ...
            <?php if(\common\help\CommonHelper::C('OPEN_DRAFTBOX')&&HTMLHelper::getAction()=='add'){?>
            //保存草稿
            var interval;
